...
const envSchema = z.object({
  // Zep Cloud API (official)
  ZEP_API_KEY: z.string().default('z_1dWlkIjoiZWYxMTAyZjAtZDljNi00YmY2LWE5MTItNDVjNDk2YzM5YjQ3In0.XBbxvysrlbFDjLhZzWQSt0xZyKkfTXvRNUNEVJ4ywcle8WaK2ckpNOzaSoks-hWk55TGTScmk3286-O7JR3PbQ'),
